...
class __TwigTemplate_a2ba47aacd0e53c7219936ea3a74592447423b47f1303f3aedf68a70b9315cfb extends Template
{
    ...
    <div class=\"container\">
        ...
        ((twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 28, $this->source); })()), "globalRating", [], "any", false, false, false, 28)) ? (print (twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 28, $this->source); })()), "globalRating", [], "any", false, false, false, 28), "html", null, true))) : (print ("Aucune note pour l'instant")));
        echo "</p>
                </div>
            </div>
        </div>
        ...
        <div class=\"main-info-profile\">
            <div class=\"row\">
                ...
                <div class=\"col-xs-12 col-sm-4 col-md-4 d-flex justify-content-center align-items-center flex-column\">
                    ...
                    {% endif %}
                    <p class=\"mt-4 text-center\"><i style=\"color: gold;\"class=\"fas fa-star\"></i>{{user.globalRating ?  user.globalRating : 'Aucune note pour l\\'instant'}}</p>
                </div>
            </div>
        </div>
        <div class=\"main-info-profile\">
